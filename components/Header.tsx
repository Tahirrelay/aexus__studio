...
export default function MinimalHeader() {
  ...
  return (
    <>
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-10 h-10 md:w-12 md:h-12 rounded-full border border-white/20 bg-transparent flex items-center justify-center text-white hover:bg-white/10 transition-all focus:outline-none"
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-[998] bg-[#05060a]/95 backdrop-blur-2xl flex flex-col items-center justify-center gap-8">
