        ...
        <div className="max-w-[1600px] mx-auto px-4 md:px-8 lg:px-12 mb-8 md:mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 relative z-10">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white uppercase">
              Client Testimonials & <span className="text-orange-500">Proof of Trust</span>
            </h2>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4 sm:mb-8">
                  ...
                  <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white/25 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="mt-auto pt-4 sm:pt-6 border-t border-white/10 flex items-center justify-between">
                  ...
                  {/* Arrow indicator */}
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border border-white/10 flex items-center justify-center text-white/50 transition-all duration-300" aria-hidden="true">
